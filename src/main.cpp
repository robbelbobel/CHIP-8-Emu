...
#define EMULATION_SPEED 50000 // Emulation Speed In Hz

// Global Variables
uint8_t keyMap[16] = {SDL_SCANCODE_X, SDL_SCANCODE_1, SDL_SCANCODE_2, SDL_SCANCODE_3, SDL_SCANCODE_A, SDL_SCANCODE_Z, SDL_SCANCODE_E, SDL_SCANCODE_Q, SDL_SCANCODE_S, SDL_SCANCODE_D, SDLK_w, SDL_SCANCODE_C, SDL_SCANCODE_4, SDL_SCANCODE_R, SDL_SCANCODE_F, SDL_SCANCODE_V};
